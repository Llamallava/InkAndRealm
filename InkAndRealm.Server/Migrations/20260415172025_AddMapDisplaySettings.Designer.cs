...
namespace InkAndRealm.Server.Migrations
{
    ...
    [Migration("20260415172025_AddMapDisplaySettings")]
    partial class AddMapDisplaySettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InkAndRealm.Server.Data.MapShareEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InkAndRealm.Server.Data.MapShareEntity", b =>
                {
                    b.HasOne("InkAndRealm.Server.Data.MapEntity", "Map")
                        .WithOne("Share")
                        .HasForeignKey("InkAndRealm.Server.Data.MapShareEntity", "MapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
